...
<!-- set Sub Specialization-->
 ...
 <div class="box-2">
    <div class="col-md-3 col-xs-5 text-center">
    <span id="js-outputExperience" style="background:gold;font-size:25px;"></span>&nbsp;<span style="background:gold;font-size:25px;">Year</span>
    <div class="back-ground">
    <p class="title-name-2">Experience</p>
    </div>
    </div>
  ...
  <div class="box-2">
    <div class="col-md-3 col-xs-5 text-center">
    	<span style="background:gold;font-size:25px;">$</span>
    	<span id="js-output" style="background:gold;font-size:25px;"></span>
    <div class="back-ground">
