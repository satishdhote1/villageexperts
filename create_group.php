...
?>
  ...
  <div class="main_body_box" style="background:none;">
      <div class="container"> 
  		<h2 style="text-align:center; color: #0078AC;">Create Group</h2>        
      	<div class="col-lg-3"> 
        </div>   
      	<div class="col-lg-6">
        	<div class="main-box" style="border:none;">
              <form action="add_group.php" method="post" enctype="multipart/form-data">
                  <div class="user_box">
                      <span class="user_text">Group Name*</span>
                      <div class="user_fild_box">
                      	<input name="group_name" class="user_fild_box_main" type="text" required>
                      </div>
                  </div>
                  
                  <div class="user_box">
                      <span class="user_text">Group Description</span>
                      	<textarea name="group_description" style="width:100%; float:left; height:100px;"></textarea>
                  </div>
                  
                  <div class="user_box">
                      <span class="user_text">Group Thumbnail</span>
                      	<input name="group_thumbnail" class="" type="file" accept="image/jpeg"  >
                  </div>
                  <input type="submit" class="sign_up_button" value="Create Group">
              </form>
            </div>
        </div>
