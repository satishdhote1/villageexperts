        ...
        <div class="full-bg-img" style="min-height:310px;position:relative;">
            <div class="container-fluid">
                ...
                <div class="col-md-5 col-md-chang">
                  <div class="m-b-0">
                      <a class="btn btn-danger  modify-btn-1 text-xs-right btn-lg modal__trigger loginModal" <?php echo ((isset($_SESSION['logged_user_id']) && !empty($_SESSION['logged_user_id'])) || (isset($_COOKIE['VEemail']) && $_COOKIE['VEemail'] != ""))?'href="friends-family.php" id="" data-toggle="" ':'href="" id="display-form" data-toggle="modal"' ?> data-target="#myModal"><span class="ICON-holder"><img src="images/icon-1.png"></span>Connect with Friends and Family</a>
                   </div>
                  <div class="m-b-0">
