...
$_SESSION['logged_user_email']=isset($_COOKIE['VEem'])?$_COOKIE['VEem']:$_SESSION['logged_user_email'];
if(!empty($_SESSION['logged_user_email']))
{
       $sqlParent = "select * from friendsRegister where email = '".base64_decode($_COOKIE['VEem'])."'";
       ...
       if (mysqli_num_rows($tableResultParent) > 0)  
      {
        ...
        $_SESSION['logged_user_email'] = $resultParentData['email'];
           ...
           <div class="col-md-5 col-xs-offset-1">
             <div id="" class="m-t-3">
                  ...
                  <!-- Modal content-->
                    ...
                    <div><a href="#" data-target="#pwdModal" data-toggle="modal">Forgot my password</a></div>
                   		<div class="text-xs-center"> 
