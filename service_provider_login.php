...
?>
  ...
  <div class="container">
  <span class="service_request_text">Service Provider Login Page</span>
  ...
  <div class="user_text_fild"><input name="email" class="user_text_fild_main" type="email" required></div>
  </div>
