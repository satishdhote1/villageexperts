...
<div class="col-1 text-center"><img src="images/img-2.jpg" class="img-responsive"> 
    <h2 class="connect text-center"><a class="navmenu  <?php echo($user_type == 'SP' )? 'disabled-pointer':''?>" href="<?php echo($user_type != 'SP')?'existingProvider.php':''?> ">Existing Provider</a></h2> 
...
<div class="col-1 text-center"><img src="images/img-3.jpg" class="img-responsive"> 
    <h2 class="connect text-center"><a class="navmenu <?php echo($user_type == 'SP' )? 'disabled-pointer':''?>" href="<?php echo($user_type != 'SP')?'newProvider.php':''?> " >New Provider</a></h2> 
...
<div class="col-1 text-center"><img src="images/Search-icon.png" class="img-responsive"> 
    <h2 class="connect text-center"><a class="navmenu  <?php echo($user_type == 'SP' )? 'disabled-pointer':''?>" href="<?php echo($user_type != 'SP')?'searchProvider.php':''?>">Search Provider</a></h2> 
