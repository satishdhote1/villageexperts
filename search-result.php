...
<div class="container-fluid container-bg">
    ...
    <nav class="nav-container hidden hideNav">
      ...
      <ul class="nav-list">
        ...
        <li class="list-item  back-color-5 expertiseClick" id="expertiseClick">Expertise
          ...
          <p class="value-holder"><input type="text" readonly class="specialisation" value="" name="specialisation">
        ...
        <li class="list-item back-color-3 disable-section subSpecialClick" id="subSpecialClick">Sub Specialisation
          ...
          <p class="value-holder"><input type="text" readonly class="subSpecial" value="" name="subSpecial">
        ...
        <li class="list-item back-color-4 degreeClick" id="degreeClick">Degree
          ...
          <p class="value-holder"><input type="text" readonly class="degree" value="" name="degree">
 ...
 <li class="list-item back-color-4 ExperienceClick" id="ExperienceClick">Experience

          <div class="select-item"><img src="images/img-3.jpg" class="img-responsive"></div>

          <p class="value-holder"><input type="text" readonly class="experience" value="" name="experience">
        ...
        <li class="list-item back-color-2 rateClick" id="rateClick">rate per hour
          ...
          <p class="value-holder"><input type="text" readonly class="rate" value="" name="rate">
        ...
        <li class="list-item back-color-6 languageClick" id="languageClick">Language
          ...
          <div class="select-item"><img src="images/img-3.jpg" class="img-responsive"></div>
           ...
           <p class="value-holder"><input type="text" readonly class="language" value="" name="language">
    ...
    <div class="col-md-10 col-md-offset-2">
      ...
      <div class="panel-box">
        ...
        <div id="lang-box">
          ...
          <div class="search-header">Search for <i><font color="#fff"><span class="searchHeader">Language</span></font></i></div>

          <div class="search-inner-block" >

            <div class="row">
				<div class="col-md-12 ratePhour" style="display:none">
                 <h4>Select maximum rate you willing to pay:</h4><div class="seclect-box" style="width:100%!important"><input type="range" min="0" max="100" step="1" value="10" data-rangeslider>$<span id="js-output"></span></div>
</div>
