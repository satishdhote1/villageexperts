       ...
       <input type="hidden" name="passwordChanged" class="passwordChanged" value="<?php echo ($tableResult == 1 && $changePWD == 1)?"1":"0"; ?>">
		       ...
		       <div class="col-md-6 col-xs-12">
		        ...
		        <div class=" main-block">
		           ...
		           <div class="col-xs-6" style="padding-left:0">
		            <input id="form7 " readonly onfocus="this.removeAttribute('readonly');" class="form-control Ldate" name="pwds" tabindex="11" type="password" value="" placeholder="Change your password" style="margin:0;height:auto;">
		            <label for="form7"></label>
		          </div>
		         </div>
		      </div>
