		       ...
		       <div class="col-md-6 col-xs-12">
		        ...
		        <div class=" main-block" style="padding-top:20px;">
		           ...
		           <div class="col-xs-6" style="padding-left:0">
		            <input id="form7 " autocomplete="off" class="form-control Ldate" name="expertiesData" tabindex="10" type="text" value="<?php echo $resultParentData['experties'] ;?>" placeholder="Data" style="margin:0;height:auto;">
		            <label for="form7"></label>
		          </div>
		         </div>
		        ...
		        <div class=" main-block">
		           ...
		           <div class="col-xs-6" style="padding-left:0">
		            <input id="form7 " autocomplete="off" class="form-control Ldate" name="pwds" tabindex="11" type="password" value="" placeholder="Data" style="margin:0;height:auto;">
		            <label for="form7"></label>
		          </div>
		         </div>
		      </div>
