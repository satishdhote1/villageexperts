...
<style>
    ...
    .btnUserOnline{
        ...
        height: 30px;
        border-radius: 8px;
        padding:7px 7px;background:lightgreen;border-radius:3px;font-size:14px;color:#000;text-align:center;width:107px;margin:auto;font-weight:bold;
    ...
    .btnUserInactive{
        ...
        height: 30px;
        border-radius: 8px;
        padding:7px 7px;background:lightgray;border-radius:3px;font-size:14px;color:#000;text-align:center;width:107px;margin:auto;font-weight:bold;
    ...
    .btnUserBusy{
        ...
        height: 30px;
        border-radius: 8px;
        padding:7px 7px;background:yellow;border-radius:3px;font-size:14px;color:#000;text-align:center;width:107px;margin:auto;font-weight:bold;
    ...
    .btnUserOffline{
        ...
        height: 30px;
        border-radius: 8px;
    padding:7px 7px;background:red;border-radius:3px;font-size:14px;color:#000;text-align:center;width:107px;margin:auto;font-weight:bold;
    }
    .bg-primary > th {
        padding: 10px 0;
    }
        ...
        <div class="container">
            ...
            <div class="logo-modify">
                ...
                <a class="navbar-brand" href="#" target="_blank">
                    ...
                    <p class="brand-text">VILLAGE EXPERTS</p></a>
        ...
        <div class="">
             ...
             if(!empty($expertData))
            {
                ...
                <tr class="elRow" id="elRow<?php echo $expertDatas['id']; ?>">
                    ...
                    <?php }
                    else if( $expertDatas['loginStatus']=='NO'){ ?>
                    ...
                    <?php }
                    else if( $expertDatas['loginStatus']=='BUSY'){ ?>
