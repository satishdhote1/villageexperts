...
?>
 ...
 // $qrySearch=mysqli_query($bd, "SELECT * FROM service_provider WHERE Profession='$expertise'");
...
mins</div>
 ...
 <!-- <?php
  $DegreeLevel=$memSearch['DegreeLevel'];
  $qryLevel=mysqli_query($bd, "SELECT * FROM educationlevel WHERE LevelofEducationID='$DegreeLevel'");
  $memLevel=mysqli_fetch_assoc($qryLevel)
  ?>
  
  <?php echo $memLevel['LevelofEducation']; ?> <br />-->
   <?php
...
//window.open('service_requestor_profile_page.php');
//location.href = "communication_module.html?SPID=<?php echo $spID; ?>&SRID=<?php echo $SRID; ?>";

//http://52.8.183.220:8086/newsession/:'.$name);
