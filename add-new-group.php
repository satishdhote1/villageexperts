...
<div class="container">
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="add-new">
        <h1 class="hder">Group Registration<span class="icon-overlap"><img src="images/icon-logo.png"></span></h1>
        <form name="newGroup" id="newGroup" method="post" action="add-new-group-save.php" enctype="multipart/form-data">
        <div class="row witdh-modify">
          <div class="col-sm-6">
            <div class="form-group form-group-gap">
             
              <label class="col-sm-3 control-label" for="firstname">Group Name</label>
              <div class="col-sm-9">
                <input type="text" value="" id="group_name" placeholder="Group-Name" class="form-control dorder0 group_name" name="group_name">
              </div>
               <div class="clearfix"></div>
            </div>
            <div class="form-group form-group-gap">
              ...
              <div class="col-sm-9">
                <textarea placeholder="Description" class="form-control dorder0 description" id="description" rows="4" cols="48" name="description"> </textarea>
              </div>
              <div class="clearfix"></div>
            </div>
            <div class="form-group form-group-gap">  
       <label class="col-sm-3 control-label" for="description">Upload Image</label>      
          ...
          <div class="col-sm-6"> 
                ...
                <div class="upload-img-block"> <img width="150" height="150" src="images/img-3.jpg" id="preview">    
        </div>
    <div><input type="submit" class="group-submit" value="Register Group" id="submit" name="submit"></div>
